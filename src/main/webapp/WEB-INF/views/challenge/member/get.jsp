...
<script>
	$(document).ready(function() {
		...
		// 이메일 input 요소에 text 변경시 이메일 중복 확인버튼 활성화
		...
		// 닉네임 input 요소에 text 변경시 닉네임 중복 확인버튼 활성화
...
<body>
	<my:navBar path="memberInfo"></my:navBar>
			...
			<div class="col-12 col-lg-6">	
				...
				<div>
					...
					<div class="input-group">
						...
						<button class="btn btn-secondary" id="nickNameCheckButton1" disabled>닉네임 중복 확인</button>
					</div>
